...
namespace Squirrel\EntitiesBundle\Tests\TestEntities2 {
    ...
    class UserRepositoryReadOnly implements RepositoryBuilderReadOnlyInterface
    {
        ...
        public function select(): \Squirrel\Entities\Action\SquirrelEntitiesBundleTestsTestEntities2User\SelectEntries
        {
            return new \Squirrel\Entities\Action\SquirrelEntitiesBundleTestsTestEntities2User\SelectEntries($this->repository);
        }
    }
}

namespace Squirrel\Entities\Action\SquirrelEntitiesBundleTestsTestEntities2User {
    /*
    ...
    class SelectIterator implements \Squirrel\Entities\Action\ActionInterface, \Iterator
    {
        ...
        /**
         * @return \Squirrel\EntitiesBundle\Tests\TestEntities2\User|null
         */
