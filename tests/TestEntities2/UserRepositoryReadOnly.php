 ...
 *
 * IF YOU DELETE THE ENTITY (Squirrel\EntitiesBundle\Tests\TestEntities2\User)
...
namespace Squirrel\Entities\Builder\SquirrelEntitiesBundleTestsTestEntities2User {
    /**
     * @implements \Iterator<int,\Squirrel\EntitiesBundle\Tests\TestEntities2\User>
     */
    class SelectIterator extends \Squirrel\Entities\Builder\SelectIterator
    {
        public function current(): \Squirrel\EntitiesBundle\Tests\TestEntities2\User
        {
            $entry = parent::current();

            if ($entry instanceof \Squirrel\EntitiesBundle\Tests\TestEntities2\User) {
                return $entry;
            }
     ...
     * SelectEntries class
     *
     * @implements \IteratorAggregate<int,\Squirrel\EntitiesBundle\Tests\TestEntities2\User>
     */
    class SelectEntries extends \Squirrel\Entities\Builder\SelectEntries
    {
        ...
        {
            /** @var \Squirrel\EntitiesBundle\Tests\TestEntities2\User[] $entries */
        ...
        public function getOneEntry(): ?\Squirrel\EntitiesBundle\Tests\TestEntities2\User
        {
            ...
            if ($entry instanceof \Squirrel\EntitiesBundle\Tests\TestEntities2\User || $entry === null) {
                return $entry;
            }
